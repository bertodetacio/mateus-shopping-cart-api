...
public class CoreBusinessModelShort extends BaseModelShort implements Serializable {
	...
	private final Set<CustomerCompanyModelShort> customerCompanySet = new HashSet<CustomerCompanyModelShort>(); 
