...
public interface DepartmentControllerOpenApi {
	...
	@Operation(summary = "Find all Departments.", responses = {
	...
	@Operation(summary = "Find Department by id", responses = {
			@ApiResponse(responseCode = "200", description = "OK"),
			@ApiResponse(responseCode = "400", description = "Invalid request", content = {
					@Content(schema = @Schema(ref = "Problem")) }),
			@ApiResponse(responseCode = "404", description = "Resource not found", content = {
	...
	DepartmentModelShort findDepartmentById(Long departmentId);
